                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col">
                             ...
                             <asp:GridView class ="table table-striped table-bordered" ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"  DataKeyNames="publisher_id">
                                 <Columns>
